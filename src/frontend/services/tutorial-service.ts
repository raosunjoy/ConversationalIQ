...
import {
  Tutorial,
  TutorialStep,
} from '../components/common/InteractiveTutorial';
...
class TutorialService {
  ...
  private createAgentOnboardingTutorial(): Tutorial {
    return {
      ...
      description:
        'Learn the basics of using ConversationIQ to enhance your customer conversations.',
      ...
      steps: [
        {
          ...
          title: 'Welcome to ConversationIQ',
          content:
            "ConversationIQ appears in your Zendesk sidebar and provides real-time insights about customer conversations. Let's explore the main features together.",
        ...
        },
        {
          ...
          content:
            "This panel shows the customer's current emotional state. Green means positive, yellow is neutral, and red indicates frustration or negative sentiment.",
        ...
        },
        {
          ...
          content:
            "Here you'll find AI-generated response suggestions tailored to the conversation context. Click any suggestion to insert it into your reply.",
        ...
        },
        {
          ...
          content:
            'Track conversation health, customer journey, and your performance metrics in real-time.',
        ...
        },
        {
          ...
          content:
            "Click on any response suggestion to see how it works. Don't worry, you can edit it before sending!",
          target: '.suggestion-card:first-child',
          position: 'left',
          action: 'click',
          validation: () =>
            document.querySelector('.zendesk-editor')?.textContent?.length > 0,
        },
      ],
    };
  }
  ...
  private createSentimentAnalysisTutorial(): Tutorial {
    return {
      ...
      description:
        'Master the art of reading customer emotions and adapting your responses accordingly.',
      category: 'getting-started',
      estimatedDuration: 7,
      ...
      steps: [
        {
          ...
          content:
            'Sentiment is shown as a color-coded indicator with a confidence score. High confidence (90%+) means the AI is very sure about the emotional reading.',
        ...
        },
        {
          ...
          content:
            "This chart shows how the customer's mood has changed throughout the conversation. Look for patterns and turning points.",
        ...
        },
        {
          ...
          content:
            'Beyond basic sentiment, we identify specific emotions like frustration, confusion, or appreciation. Use this to craft more empathetic responses.',
        ...
        },
        {
          ...
          content:
            "When sentiment drops significantly, you'll see alerts here. These help you catch potential escalations early.",
  ...
  private createResponseSuggestionsTutorial(): Tutorial {
    return {
      ...
      description:
        'Learn how to effectively use and customize AI-generated response suggestions.',
      category: 'getting-started',
      estimatedDuration: 8,
      prerequisites: ['agent-onboarding'],
      steps: [
        {
          ...
          content:
            'Suggestions are categorized by type: Empathy (💙), Solution (⚡), Information Gathering (❓), and De-escalation (🔧).',
        ...
        },
        {
          ...
          content:
            'Each suggestion has a confidence score. Higher scores mean the AI believes this response is more likely to be effective.',
        ...
        },
        {
          ...
          content:
            'Always personalize suggestions to match your voice and the specific customer situation. Click the edit icon to modify before inserting.',
        ...
        },
        {
          ...
          content:
            'Use the thumbs up/down buttons to rate suggestion quality. This helps improve future recommendations.',
        ...
        },
        {
          ...
          content:
            'Found a suggestion that works well? Save it as a personal template for future use.',
  ...
  private createEscalationPreventionTutorial(): Tutorial {
    return {
      ...
      description:
        'Learn to identify and prevent potential escalations before they happen.',
      category: 'advanced',
      ...
      steps: [
        {
          ...
          content:
            'Watch for these risk levels: Green (low), Yellow (medium), Red (high), and Flashing Red (critical). Each requires different response strategies.',
        ...
        },
        {
          ...
          content:
            "The AI monitors conversation patterns, sentiment trends, and customer history to predict escalation risk before it's obvious.",
        ...
        },
        {
          ...
          content:
            "When risk is detected, you'll see specialized de-escalation suggestions. These are proven techniques for calming frustrated customers.",
        ...
        },
        {
          ...
          content:
            "Critical risk situations trigger supervisor alerts. Don't wait - proactive escalation often leads to better outcomes.",
  ...
  private createBetaFeedbackTutorial(): Tutorial {
    return {
      ...
      description:
        'Learn how to effectively provide feedback during the beta program.',
      category: 'beta',
      estimatedDuration: 4,
      steps: [
        {
          ...
          content:
            'Click this floating button anytime to share feedback about your experience with ConversationIQ.',
        ...
        },
        {
          ...
          content:
            'You can submit feature requests, bug reports, general feedback, or satisfaction ratings. Each type helps us improve different aspects.',
        ...
        },
        {
          ...
          content:
            'Help us prioritize by setting the right urgency level. Critical issues get immediate attention from our development team.',
  ...
  private createManagerDashboardTutorial(): Tutorial {
    return {
      ...
      description:
        'Explore the comprehensive analytics and management tools for team leaders.',
      category: 'advanced',
      ...
      steps: [
        {
          ...
          content:
            "Get a bird's-eye view of your team's performance with key metrics like CSAT, FCR, and escalation rates.",
        ...
        },
        {
          ...
          content:
            "Drill down into each agent's performance to identify top performers and coaching opportunities.",
        ...
        },
        {
          ...
          content:
            "Get personalized coaching recommendations based on each agent's interaction patterns and areas for improvement.",
        ...
        },
        {
          ...
          content:
            'Understand customer trends, common issues, and opportunities for process improvement.',
  ...
  private createAnalyticsDashboardTutorial(): Tutorial {
    return {
      ...
      description:
        'Master the analytics dashboard to track your performance and identify improvement opportunities.',
      category: 'advanced',
      estimatedDuration: 8,
      prerequisites: ['agent-onboarding'],
      steps: [
        {
          ...
          content:
            'Track your CSAT scores, response times, resolution rates, and sentiment improvement over time.',
        ...
        },
        {
          ...
          content:
            'Identify patterns in your performance data to understand your strengths and areas for improvement.',
  ...
  private createCustomTemplatesTutorial(): Tutorial {
    return {
      ...
      description:
        'Learn to create and manage personalized response templates for common scenarios.',
      category: 'advanced',
      estimatedDuration: 6,
      ...
      steps: [
        {
          ...
          content:
            'Save your most effective responses as templates for future use. This builds your personal knowledge base.',
  ...
  private createPerformanceOptimizationTutorial(): Tutorial {
    return {
      ...
      description:
        'Advanced techniques for maximizing your effectiveness with ConversationIQ.',
      category: 'advanced',
      estimatedDuration: 10,
      ...
      steps: [
        {
          ...
          content:
            'Learn keyboard shortcuts and workflow tips to work more efficiently with ConversationIQ.',
  ...
  private createFeatureFlagTutorial(): Tutorial {
    return {
      ...
      description:
        'Learn about beta features and how feature flags work in ConversationIQ.',
      category: 'beta',
      estimatedDuration: 5,
      steps: [
        {
          ...
          content:
            'Feature flags allow us to gradually roll out new features to beta users like you for testing.',
  ...
  private createTeamAnalyticsTutorial(): Tutorial {
    return {
      ...
      description:
        'Advanced team analytics and coaching insights for managers.',
      category: 'advanced',
      ...
      steps: [
        {
          ...
          content:
            "Compare your team's performance against benchmarks and identify areas for collective improvement.",
  ...
  updateStepProgress(userId: string, tutorialId: string, stepId: string): void {
    const userState = this.getUserState(userId);
    const progress = userState.tutorialProgress[tutorialId];
  ...
  getTutorialAnalytics(userId: string): {
    ...
    const completedProgress = Object.values(userState.tutorialProgress).filter(
      p => p.completed
    );
    const averageTimePerTutorial =
      completedProgress.length > 0
        ? completedProgress.reduce((sum, p) => sum + p.timeSpent, 0) /
    ...
    completedProgress.forEach(progress => {
      ...
      if (tutorial) {
        categoryCount[tutorial.category] =
          (categoryCount[tutorial.category] || 0) + 1;
      }
    });
