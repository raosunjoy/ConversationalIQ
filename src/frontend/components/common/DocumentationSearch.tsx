...
export interface DocumentationItem {
  ...
  title: string;
  content: string;
  category: 'user-guide' | 'api-docs' | 'tutorials' | 'help' | 'troubleshooting';
  subcategory?: string;
  tags: string[];
...
class DocumentationSearchService {
  ...
  private initializeDocuments(): void {
    ...
    this.addDocument({
      ...
      content: 'Welcome to ConversationIQ! This comprehensive guide will help you get the most out of our AI-powered conversation intelligence platform. Learn about dashboard overview, real-time features, response suggestions, sentiment analysis, escalation prevention, and analytics.',
      category: 'user-guide',
      ...
      excerpt: 'Learn the fundamentals of ConversationIQ including setup, authentication, and main interface components.',
    });

    this.addDocument({
      id: 'agent-guide-sentiment-analysis',
      title: 'Understanding Sentiment Analysis',
      content: 'ConversationIQ uses advanced AI to analyze customer emotions in real-time. Learn how to read sentiment indicators, understand confidence scores, track emotion trends, and use sentiment data to improve customer interactions.',
      category: 'user-guide',
      subcategory: 'agent-guide',
      ...
      excerpt: 'Master sentiment analysis to better understand and respond to customer emotions.',
    });

    this.addDocument({
      id: 'agent-guide-response-suggestions',
      title: 'Using AI Response Suggestions',
      content: 'Learn how to effectively use AI-generated response suggestions. Understand different types of suggestions (empathy, solution, information gathering), confidence scores, customization techniques, and best practices for personalization.',
      category: 'user-guide',
      subcategory: 'agent-guide',
      ...
      excerpt: 'Master AI response suggestions to provide faster, more effective customer support.',
    });

    this.addDocument({
      id: 'agent-guide-escalation-prevention',
      title: 'Preventing Customer Escalations',
      content: 'ConversationIQ helps identify potential escalations before they happen. Learn about risk indicators, early warning systems, de-escalation strategies, and when to involve supervisors.',
      category: 'user-guide',
      subcategory: 'agent-guide',
      ...
      excerpt: 'Proactively prevent escalations with AI-powered risk detection and proven de-escalation techniques.',
    });
    ...
    this.addDocument({
      ...
      content: 'Comprehensive analytics and management tools for team leaders. Monitor team performance, individual agent analytics, coaching insights, and business intelligence. Track KPIs, identify improvement opportunities, and make data-driven decisions.',
      category: 'user-guide',
      ...
      excerpt: 'Use the manager dashboard to optimize team performance and track business metrics.',
    });

    this.addDocument({
      id: 'manager-guide-performance-analytics',
      title: 'Performance Analytics for Managers',
      content: 'Deep dive into individual agent analysis, comparative performance, team trends and patterns. Learn how to use AI-powered coaching insights, identify top performers, and develop improvement strategies.',
      category: 'user-guide',
      subcategory: 'manager-guide',
      ...
      excerpt: 'Analyze team performance and provide data-driven coaching to improve results.',
    });
    ...
    this.addDocument({
      ...
      content: 'ConversationIQ uses JWT-based authentication with Zendesk OAuth integration. Learn about the authentication flow, required headers, token structure, and security best practices.',
      category: 'api-docs',
      tags: ['authentication', 'jwt', 'oauth', 'security', 'api'],
      difficulty: 'intermediate',
      lastUpdated: new Date(),
      url: '/docs/api-documentation.md#authentication',
      excerpt: 'Secure API access using JWT tokens and Zendesk OAuth integration.',
    });

    this.addDocument({
      id: 'api-conversations',
      title: 'Conversations API',
      content: 'REST API endpoints for managing conversations. Get conversations, retrieve conversation details with analytics, filter by status and date ranges, access sentiment analysis and performance metrics.',
      category: 'api-docs',
      tags: ['api', 'conversations', 'rest', 'endpoints', 'analytics'],
      difficulty: 'intermediate',
      lastUpdated: new Date(),
      url: '/docs/api-documentation.md#conversations',
      excerpt: 'Programmatically access and manage customer conversations through the API.',
    });

    this.addDocument({
      id: 'api-response-suggestions',
      title: 'Response Suggestions API',
      content: 'API endpoints for AI-generated response suggestions. Get suggestions by conversation ID, filter by type, provide feedback on suggestion quality, and track suggestion performance.',
      category: 'api-docs',
      tags: ['api', 'suggestions', 'ai', 'responses', 'feedback'],
      difficulty: 'advanced',
      lastUpdated: new Date(),
      url: '/docs/api-documentation.md#response-suggestions',
      excerpt: 'Integrate AI response suggestions into your applications via REST API.',
    });

    this.addDocument({
      id: 'api-graphql',
      title: 'GraphQL API',
      content: 'GraphQL endpoint for flexible data querying. Schema overview, example queries and mutations, real-time subscriptions for conversation updates, and WebSocket integration.',
      category: 'api-docs',
      tags: ['graphql', 'api', 'queries', 'subscriptions', 'realtime'],
      difficulty: 'advanced',
      lastUpdated: new Date(),
      url: '/docs/api-documentation.md#graphql-api',
      excerpt: 'Use GraphQL for flexible, efficient data querying and real-time subscriptions.',
    });
    ...
    this.addDocument({
      ...
      content: 'Interactive walkthrough of ConversationIQ for new agents. Learn the sidebar interface, sentiment panel, suggestions panel, analytics panel, and how to try your first suggestion.',
      category: 'tutorials',
      tags: ['tutorial', 'onboarding', 'interactive', 'getting-started'],
      difficulty: 'beginner',
      lastUpdated: new Date(),
      url: '/tutorials/agent-onboarding',
      excerpt: 'Step-by-step interactive tutorial for new ConversationIQ users.',
    });

    this.addDocument({
      id: 'tutorial-sentiment-mastery',
      title: 'Sentiment Analysis Deep Dive Tutorial',
      content: 'Advanced tutorial on mastering sentiment analysis. Learn to read indicators, understand trends, analyze emotions, and respond to sentiment-based alerts effectively.',
      category: 'tutorials',
      tags: ['tutorial', 'sentiment', 'advanced', 'emotions'],
      difficulty: 'intermediate',
      lastUpdated: new Date(),
      url: '/tutorials/sentiment-analysis',
      excerpt: 'Master sentiment analysis with this comprehensive interactive tutorial.',
    });
    ...
    this.addDocument({
      ...
      content: 'If sentiment readings don\'t match your assessment, check message context for sarcasm or complex language, review confidence scores, consider cultural differences, and use the feedback system to improve accuracy.',
      category: 'troubleshooting',
      tags: ['troubleshooting', 'sentiment', 'accuracy', 'feedback'],
      difficulty: 'intermediate',
      lastUpdated: new Date(),
      url: '/docs/agent-user-guide.md#troubleshooting',
      excerpt: 'Resolve issues with sentiment analysis accuracy and interpretation.',
    });

    this.addDocument({
      id: 'troubleshooting-no-suggestions',
      title: 'No Response Suggestions Appearing',
      content: 'When suggestions don\'t appear, ensure sufficient conversation context, check internet connection, verify supported issue types, and refresh the app if needed.',
      category: 'troubleshooting',
    ...
    this.addDocument({
      ...
      content: 'Resolve slow loading and delayed suggestions by checking internet speed, closing unnecessary tabs, clearing browser cache, trying different browsers, and contacting support if issues persist.',
      category: 'troubleshooting',
    ...
    this.addDocument({
      ...
      content: 'Maximize efficiency with keyboard shortcuts: Alt+S (focus suggestions), Ctrl+1-9 (insert suggestions), Ctrl+E (edit suggestion), Ctrl+R (refresh analysis), and many more.',
      category: 'help',
    ...
    this.addDocument({
      ...
      content: 'Help improve ConversationIQ by providing effective feedback. Learn about feedback types, urgency levels, writing helpful reports, and using the feedback widget.',
      category: 'help',
      tags: ['beta', 'feedback', 'improvement', 'testing'],
      difficulty: 'beginner',
      lastUpdated: new Date(),
      url: '/docs/agent-user-guide.md#beta-features',
      excerpt: 'Contribute to product improvement through effective beta feedback.',
    });
  }
  ...
  private buildSearchIndex(): void {
    this.documents.forEach(doc => {
      ...
      const words = [...doc.title.toLowerCase().split(/\s+/), ...doc.content.toLowerCase().split(/\s+/)];
  ...
  search(query: string, filters: Partial<SearchFilters> = {}): SearchResult[] {
    ...
    const candidateResults = new Map<string, { doc: DocumentationItem; scores: number[] }>();
    ...
    candidateResults.forEach(({ doc, scores }) => {
      ...
      if (filters.difficulty && filters.difficulty !== 'all' && doc.difficulty !== filters.difficulty) {
        return;
      }
      ...
      const relevanceReason = this.generateRelevanceReason(doc, queryWords, scores);
  ...
  private generateRelevanceReason(doc: DocumentationItem, queryWords: string[], scores: number[]): string {
  ...
  getAllCategories(): string[] {
    return ['all', 'user-guide', 'api-docs', 'tutorials', 'help', 'troubleshooting'];
  }
    ...
    >
      <div className="flex items-start justify-between mb-2">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Badge 
            type={result.difficulty === 'beginner' ? 'positive' : 
                  result.difficulty === 'intermediate' ? 'warning' : 'danger'}
            className="text-xs"
          >
            {result.difficulty}
          </Badge>
      ...
      <div className="flex items-center justify-between">
        <div className="flex flex-wrap gap-1">
          ...
          {result.tags.filter(tag => !result.matchingTags.includes(tag)).slice(0, 2).map(tag => (
    ...
    <Modal isOpen={isVisible} onClose={onClose} className="max-w-4xl">
      ...
      <Body className="max-h-[70vh] overflow-y-auto">
        {selectedResult ? (
          <div className="space-y-4">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4">{selectedResult.title}</h2>
              <div className="flex items-center space-x-2 mb-4">
                <Badge type="neutral">{selectedResult.category.replace('-', ' ')}</Badge>
                <Badge 
                  type={selectedResult.difficulty === 'beginner' ? 'positive' : 
                        selectedResult.difficulty === 'intermediate' ? 'warning' : 'danger'}
                >
              ...
              <div>
                ...
                {results.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    <Alert type="warning">
                      No results found for "{query}". Try different keywords or check the popular searches below.
                    </Alert>
                  </div>
                )}
              </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {categories.filter(cat => cat !== 'all').map(category => {
                      const categoryDocs = searchService['documents'].filter(doc => doc.category === category);
                      return (
                        <div key={category} className="border rounded-lg p-4">
                          <h4 className="font-medium mb-2">{category.replace('-', ' ')}</h4>
      ...
      <Footer>
        <div className="flex justify-between items-center w-full">
          <div className="text-xs text-gray-500">
            Can't find what you're looking for? <a href="mailto:support@conversationiq.com" className="text-blue-600">Contact Support</a>
          </div>
