...
const AnalyticsPanel: React.FC<AnalyticsPanelProps> = ({ 
  ...
  const getHealthColor = (health: string): string => {
    switch (health) {
      case 'excellent': return '#228f67';
      case 'good': return '#87c442';
      case 'concerning': return '#f79a3e';
      case 'critical': return '#d93954';
      default: return '#68737d';
    }
  };

  const getEscalationRiskLevel = (risk: number): { level: string; color: string } => {
      ...
      <div className="analytics-overview">
        <div className="metrics-grid">
          <MetricCard
            ...
            subtitle="Average"
            trend={analytics.averageResponseTime < 5 ? 'positive' : 
                   analytics.averageResponseTime < 15 ? 'neutral' : 'negative'}
            icon="⏱️"
          />
          ...
          <MetricCard
            ...
            trend={analytics.escalationRisk < 0.3 ? 'positive' : 
                   analytics.escalationRisk < 0.6 ? 'neutral' : 'negative'}
            icon="⚠️"
          ...
          <MetricCard
            ...
            subtitle="Predicted"
            trend={analytics.customerSatisfactionPredict > 0.8 ? 'positive' : 
                   analytics.customerSatisfactionPredict > 0.6 ? 'neutral' : 'negative'}
            icon="😊"
          />
        </div>
      </div>
            ...
            <div className="metric-bar">
              <div 
                ...
                style={{ 
                  ...
                  backgroundColor: analytics.averageResponseTime < 10 ? '#228f67' : '#f79a3e'
                }}
              />
            </div>
            ...
            <div className="metric-bar">
              <div 
                ...
                style={{ 
                  ...
                  backgroundColor: analytics.messageCount > 5 ? '#228f67' : '#cc8400'
                }}
              />
            </div>
            <div className="metric-value">
          ...
          {analytics.escalationRisk > 0.7 && (
            <div className="recommendation-item critical">
              ...
              <div className="rec-content">
                ...
                <div className="rec-description">High escalation risk detected. Consider involving a supervisor.</div>
              </div>
            </div>
          )}
          ...
          {analytics.averageResponseTime > 15 && (
            <div className="recommendation-item warning">
              ...
              <div className="rec-content">
                ...
                <div className="rec-description">Response time is above average. Consider using AI suggestions for faster replies.</div>
              </div>
            </div>
          )}
          ...
          {analytics.customerSatisfactionPredict < 0.6 && (
            <div className="recommendation-item info">
              ...
              <div className="rec-content">
                ...
                <div className="rec-description">Consider adjusting tone and approach to improve customer experience.</div>
              </div>
            </div>
          )}
          ...
          {analytics.conversationHealth === 'excellent' && (
            <div className="recommendation-item success">
              ...
              <div className="rec-content">
                ...
                <div className="rec-description">Conversation is proceeding excellently. Keep up the good work!</div>
              </div>
            </div>
          )}
        </div>
